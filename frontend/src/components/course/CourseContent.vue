<template>
  <div>
    <div class="panel">
      ...
      <div class="lesson-list">
        <div
          ...
          :key="lesson.id"
          class="lesson-item lesson-item-column"
        >
          <div class="lesson-header-row">
            ...
            <div class="lesson-actions">
              ...
              <button
                class="icon-btn"
                type="button"
                @click="$emit('remove-lesson', index)"
              >
                🗑
              </button>
            </div>
          ...
          <div v-if="lesson.isEditing" class="lesson-editor">
            ...
            <template v-if="lesson.type === 'quiz'">
              ...
              <input
                v-model.number="lesson.quiz.passing_score"
                class="input"
                type="number"
                min="0"
                max="100"
              ...
              <input
                v-model.number="lesson.quiz.time_limit_minutes"
                class="input"
                type="number"
                min="1"
              ...
              <div class="quiz-box">
                ...
                >
                  ...
                  <button
                    class="danger-btn"
                    type="button"
                    @click="removeQuestion(lesson, qIndex)"
                  >
                    Remove question
                  </button>
                </div>
                ...
                <button
                  class="add-lesson-btn w-full"
                  type="button"
                  @click="addQuestion(lesson)"
                >
                  + Add question
                </button>
              </div>
            ...
            <template v-if="lesson.type === 'assignment'">
              <label class="field-label">Assignment instructions</label>
              <textarea
                v-model="lesson.assignment.instructions"
                class="input lesson-textarea"
                rows="6"
              ...
              <input
                v-model="lesson.assignment.due_date"
                class="input"
                type="datetime-local"
              />
              ...
              <input
                v-model.number="lesson.assignment.max_score"
                class="input"
                type="number"
                min="1"
              />
    ...
    <div class="panel mt-3">
      ...
      <div class="objectives">
        ...
        >
          ...
          <button
            class="icon-btn"
            type="button"
            @click="$emit('remove-objective', index)"
          >
            🗑
          </button>
        </div>
      ...
      <button
        class="add-lesson-btn w-full mt-2"
        type="button"
